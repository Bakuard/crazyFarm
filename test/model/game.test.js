...
async function beforeEachTestScenario(isTutorialFinished, isDebugOutput) {
    ...
    game = new Game(
        null, 
        new User({_id: '0123456789ab', loggin: 'Me', email: 'me@mail.com', passwordHash: 'pass-hash', salt: 'salt', isTutorialFinished}), 
...
describe(`grow some vegetables to 'sprout' then die,
          grow tomato to 'adult' then die and explode other vegetables`, () => {
    ...
    describe.each([
        ...
        {
            events: [
                {tool: 'seeds', cell: '0-0'}, {tool: 'seeds', cell: '0-1'}, {tool: 'seeds', cell: '1-0'}
            ], 
            elapsedMillis: 100, 
            updateNumber: 1,
            randomValue: 0.3, 
        ...
        {
            events: [
                {tool: 'seeds', cell: '1-1'}, {tool: 'seeds', cell: '0-2'}, 
                {tool: 'seeds', cell: '1-2'}, {tool: 'seeds', cell: '3-2'}
            ], 
            elapsedMillis: 100, 
            updateNumber: 1,
            randomValue: 0.5, 
            ...
            expectedGardenCells: [
                ...
                gardenBedCellDto(2, 1, false, null),
                gardenBedCellDto(3, 1, false, null),
                gardenBedCellDto(0, 2, false, vegetableDto('tomato', 0)),
                gardenBedCellDto(1, 2, false, vegetableDto('tomato', 0)),
                gardenBedCellDto(2, 2, false, null),
        ...
        {
            events: [
                {tool: 'seeds', cell: '2-2'}, {tool: 'seeds', cell: '2-0'}
            ], 
            elapsedMillis: 100, 
            updateNumber: 1,
            randomValue: 0.75, 
            ...
            expectedGardenCells: [
                gardenBedCellDto(0, 0, false, vegetableDto('potato', 0)),
                gardenBedCellDto(1, 0, false, vegetableDto('potato', 0)),
                gardenBedCellDto(2, 0, false, vegetableDto('onion', 0)),
                gardenBedCellDto(3, 0, false, null),
                gardenBedCellDto(0, 1, false, vegetableDto('potato', 0)),
                gardenBedCellDto(1, 1, false, vegetableDto('tomato', 0)),
                gardenBedCellDto(2, 1, false, null),
                ...
                gardenBedCellDto(0, 2, false, vegetableDto('tomato', 0)),
                gardenBedCellDto(1, 2, false, vegetableDto('tomato', 0)),
                gardenBedCellDto(2, 2, false, vegetableDto('onion', 0)),
                gardenBedCellDto(3, 2, false, vegetableDto('tomato', 0))
            ]
        },
        {
            events: [
                {tool: 'bailer', cell: '0-0'}, {tool: 'bailer', cell: '1-0'}, {tool: 'bailer', cell: '2-0'},
                {tool: 'bailer', cell: '0-1'},                                
                {tool: 'bailer', cell: '0-2'}, {tool: 'bailer', cell: '1-2'}, {tool: 'bailer', cell: '2-2'}
            ], 
            elapsedMillis: 3000, 
            updateNumber: 1,
            randomValue: 0.3, 
            ...
            expectedGardenCells: [
                ...
                gardenBedCellDto(2, 0, false, vegetableDto('onion', 1)),
                gardenBedCellDto(3, 0, false, null),
                gardenBedCellDto(0, 1, false, vegetableDto('potato', 1)),
                gardenBedCellDto(1, 1, false, vegetableDto('tomato', 0)),
                gardenBedCellDto(2, 1, false, null),
                gardenBedCellDto(3, 1, false, null),
                gardenBedCellDto(0, 2, false, vegetableDto('tomato', 1)),
                gardenBedCellDto(1, 2, false, vegetableDto('tomato', 1)),
                gardenBedCellDto(2, 2, false, vegetableDto('onion', 1)),
                gardenBedCellDto(3, 2, false, vegetableDto('tomato', 0))
            ]
        },
        {
            events: [
                {tool: 'bailer', cell: '0-0'},                                {tool: 'bailer', cell: '2-0'},
                                                                                      
                {tool: 'bailer', cell: '0-2'}, {tool: 'bailer', cell: '1-2'}, {tool: 'bailer', cell: '2-2'}
,
                {tool: 'fertilizer', cell: '0-0'}, {tool: 'fertilizer', cell: '1-0'}, {tool: 'fertilizer', cell: '2-0'},
                {tool: 'fertilizer', cell: '0-1'},                                    
                {tool: 'fertilizer', cell: '0-2'}, {tool: 'fertilizer', cell: '1-2'}, {tool: 'fertilizer', cell: '2-2'}
            ], 
            elapsedMillis: 100, 
            updateNumber: 500,
            randomValue: 0.75, 
            ...
            expectedGardenCells: [
                ...
                gardenBedCellDto(2, 0, false, vegetableDto('onion', 1, 'THIRST', 'HUNGER')),
                gardenBedCellDto(3, 0, false, null),
                gardenBedCellDto(0, 1, false, vegetableDto('potato', 1, 'THIRST', 'HUNGER')),
                gardenBedCellDto(1, 1, false, vegetableDto('tomato', 0)),
                gardenBedCellDto(2, 1, false, null),
                gardenBedCellDto(3, 1, false, null),
                gardenBedCellDto(0, 2, false, vegetableDto('tomato', 1, 'THIRST', 'HUNGER')),
                gardenBedCellDto(1, 2, false, vegetableDto('tomato', 1, 'THIRST', 'HUNGER')),
                gardenBedCellDto(2, 2, false, vegetableDto('onion', 1, 'THIRST', 'HUNGER')),
                gardenBedCellDto(3, 2, false, vegetableDto('tomato', 0))
            ]
        },
        {
...
,
        ...
        },
        {
            events: [
                ...
                {tool: 'bailer', cell: '0-2'}, {tool: 'bailer', cell: '1-2'}, {tool: 'bailer', cell: '2-2'}
,
                {tool: 'fertilizer', cell: '0-0'},                                    {tool: 'fertilizer', cell: '2-0'},
...
,
        ...
        {
            events: [
                {tool: 'bailer', cell: '1-1'}, {tool: 'fertilizer', cell: '1-1'}
            ], 
            elapsedMillis: 100, 
            updateNumber: 500, 
            randomValue: 0.75, 
        ...
        },
        {
            ...
            expectedMoney: 103, 
            expectedGardenCells: [
                gardenBedCellDto(0, 0, false, vegetableDto('potato', 7)),
                gardenBedCellDto(1, 0, false, null),
                gardenBedCellDto(2, 0, false, vegetableDto('onion', 7)),
                gardenBedCellDto(3, 0, false, null),
                gardenBedCellDto(0, 1, false, null),
                gardenBedCellDto(1, 1, false, vegetableDto('tomato', 6)),
                gardenBedCellDto(2, 1, false, null),
                gardenBedCellDto(3, 1, false, null),
                gardenBedCellDto(0, 2, false, vegetableDto('tomato', 8)),
                gardenBedCellDto(1, 2, false, vegetableDto('tomato', 8)),
                gardenBedCellDto(2, 2, false, vegetableDto('onion', 7)),
                gardenBedCellDto(3, 2, false, vegetableDto('tomato', 0))
            ]
        },
        {
            ...
            expectedMoney: 103, 
            expectedGardenCells: [
                gardenBedCellDto(0, 0, false, vegetableDto('potato', 6)),
                gardenBedCellDto(1, 0, false, null),
                gardenBedCellDto(2, 0, false, null),
                gardenBedCellDto(3, 0, false, null),
                gardenBedCellDto(0, 1, false, null),
